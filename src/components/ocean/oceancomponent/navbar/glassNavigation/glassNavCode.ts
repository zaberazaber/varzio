export const GlassNavigationCode = [
    {name: "GlassNav", codejs:`import { useEffect, useRef, useState } from "react";
...
export default Example;`, codets:`import { Dispatch, SetStateAction, useEffect, useRef, useState } from "react";
