...
const FlyoutNavExample = () => {
  return (
    <>
      <FlyoutNav />
      <div
        className=" overflow-y-auto relative relative min-h-screen"
        style={{
...
const FlyoutNav = () => {
  ...
  return (
    <nav
      className={`scroll-y-auto relative fixed top-0 z-50 w-full px-6 text-white 
      ...
      <AnimatePresence>
        {open && (
          <motion.nav
            ...
            className=" relative fixed left-0 top-0 flex h-screen w-full flex-col bg-white"
          >
...
export default FlyoutNavExample;
