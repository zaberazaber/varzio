  ...
  return (
    <div className="bg-white min-h-[200px] flex items-center justify-center">
      <button
        ...
        className="text-sm text-white bg-rose-500 hover:bg-rose-600 active:scale-95 transition-all font-medium px-3 py-2 rounded"
      >
        Add notification
      </button>
...
const Notification = ({
  ...
  return (
    <motion.div
      ...
      className="p-2 flex items-start rounded gap-2 text-xs font-medium shadow-lg text-white bg-rose-500 pointer-events-auto"
    >
