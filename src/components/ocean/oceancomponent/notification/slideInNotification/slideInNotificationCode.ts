export const SlideInNotificationCode = [
    {name: "SlideInNotification", codejs:`import React, { useEffect, useState } from "react";
...
const generateRandomNotif = () => {
  ...
  return data;
};`,codets:`import React, { useEffect, useState } from "react";
import { FiCheckSquare, FiX } from "react-icons/fi";
import { AnimatePresence, motion } from "framer-motion";
