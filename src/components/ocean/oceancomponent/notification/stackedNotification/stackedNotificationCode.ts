export const StackedNotificationCode = [
    {name: "StackedNotification", codejs:`import { AnimatePresence, motion } from "framer-motion";
...
const generateRandomNotif = () => {
  ...
  return data;
};`,codets:`import { AnimatePresence, motion } from "framer-motion";
import { FiAlertCircle, FiX } from "react-icons/fi";
import { useEffect, useState } from "react";
