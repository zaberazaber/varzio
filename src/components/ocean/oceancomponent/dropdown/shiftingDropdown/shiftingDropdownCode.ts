export const ShiftingDropdownCode = [
    {name: "ShiftingDropdown", codejs:`import React, { useEffect, useState } from "react";
import {
  FiArrowRight,
  FiBarChart2,
  FiChevronDown,
...
].map((n, idx) => ({ ...n, id: idx + 1 }));`,codets:`import React, { ReactNode, useEffect, useState } from "react";
import {
  FiArrowRight,
  FiBarChart2,
  FiChevronDown,
